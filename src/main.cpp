...
String mqtt_clientid = "esp32_node_sht30_bh1750_soil30";
String module_id = "esp32_node_sht30_bh1750_soil30";
...
void publish_selected_data()
{
  ...
  doc["moisture_adc"] = moisture_value;
  doc["moisture_percentage"] = percentage;
